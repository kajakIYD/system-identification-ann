...
if __name__ == "__main__":
    ...
    titles_model_inverse_data, titles_model_data = extract_models_and_inverse_models_data\
                                                    ("./inertia_modelling_checkpoints_trying_to_reproduce_MIXED_TRAINED")
    ...
    main(titles_model_inverse_data, titles_model_data, dt=0.01, simulation_time=10,
         ...
         plotting=False,
         path_to_save_mses='./inertia_simulation_performances_disturbed_trying_to_MIXED_TRAINED/',
         mses_pickle_name='inertia_simulation_performances_disturbed_trying_to_MIXED_TRAINED',
         apply_disturbances=True)

    titles_model_inverse_data, titles_model_data = extract_models_and_inverse_models_data\
                                                    ("./inertia_modelling_checkpoints_trying_to_reproduce_RECTANGLE")

    main(titles_model_inverse_data, titles_model_data, dt=0.01, simulation_time=10,
         SP=model_and_inv_model_identification.generate_rectangle(10, 1, 2, dt=0.01), suspension_simulation=False,
         plotting=False,
         path_to_save_mses='./inertia_simulation_performances_disturbed_trying_to_RECTANGLE_TRAINED/',
         mses_pickle_name='inertia_simulation_performances_disturbed_trying_to_RECTANGLE_TRAINED',
         apply_disturbances=True)
